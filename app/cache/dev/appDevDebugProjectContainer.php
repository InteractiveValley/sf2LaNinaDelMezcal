...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'laninadelmezcal', 'host' => 'localhost', 'port' => '3306', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_6addb5a3f3898e2681681ec198b25618');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_6addb5a3f3898e2681681ec198b25618');
        ...
        $g->setProxyDir('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'faed65b6670198c4a275489e150e8b2445c9ea63');
    }
    ...
    {
        return $this->services['genemu.form.jquery.type.file'] = new \Genemu\Bundle\FormBundle\Form\JQuery\Type\FileType(array('script' => 'genemu_upload', 'swf' => '/js/uploadify/uploadify.swf', 'cancelImg' => '/bundles/genemuform/images/cancel.png', 'folder' => '/upload'), '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/../web');
    }
    ...
    {
        return $this->services['genemu.gd.captcha'] = new \Genemu\Bundle\FormBundle\Gd\Type\Captcha($this->get('session'), 'faed65b6670198c4a275489e150e8b2445c9ea63');
    }
    ...
    {
        return $this->services['imagine.cache.path.resolver'] = new \Avalanche\Bundle\ImagineBundle\Imagine\CachePathResolver('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/../web', $this->get('router'));
    }
    ...
    protected function getImagine_ControllerService()
    {
        ...
        return $this->services['imagine.controller'] = $this->scopedServices['request']['imagine.controller'] = new \Avalanche\Bundle\ImagineBundle\Controller\ImagineController($this->get('request'), $this->get('imagine.cache.path.resolver'), $this->get('imagine.gd'), $this->get('imagine.filter.manager'), $this->get('filesystem'), '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/../web', '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/../web');
    }
    ...
    {
        $this->services['imagine.filter.manager'] = $instance = new \Avalanche\Bundle\ImagineBundle\Imagine\Filter\FilterManager(array('platillos_imagen' => array('type' => 'thumbnail', 'options' => array('size' => array(0 => 400, 1 => 400), 'mode' => 'inset', 'cache_type' => 'public', 'cache_expires' => '2 weeks')), 'galeria_imagen' => array('type' => 'thumbnail', 'options' => array('size' => array(0 => 700, 1 => 370), 'mode' => 'inset', 'cache_type' => 'public', 'cache_expires' => '2 weeks')), 'galeria_imagen_recortar' => array('type' => 'thumbnail', 'options' => array('size' => array(0 => 700, 1 => 370), 'mode' => 'outbound', 'cache_type' => 'public', 'cache_expires' => '2 weeks'))));
    ...
    {
        return $this->services['imagine.routing.loader'] = new \Avalanche\Bundle\ImagineBundle\Routing\ImagineLoader('media/cache', array('platillos_imagen' => array('type' => 'thumbnail', 'options' => array('size' => array(0 => 400, 1 => 400), 'mode' => 'inset', 'cache_type' => 'public', 'cache_expires' => '2 weeks')), 'galeria_imagen' => array('type' => 'thumbnail', 'options' => array('size' => array(0 => 700, 1 => 370), 'mode' => 'inset', 'cache_type' => 'public', 'cache_expires' => '2 weeks')), 'galeria_imagen_recortar' => array('type' => 'thumbnail', 'options' => array('size' => array(0 => 700, 1 => 370), 'mode' => 'outbound', 'cache_type' => 'public', 'cache_expires' => '2 weeks'))));
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        $instance->addPath('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/src/Richpolis/BackendBundle/Resources/views', 'Backend');
        $instance->addPath('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/src/Richpolis/PublicacionesBundle/Resources/views', 'Publicaciones');
        $instance->addPath('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/src/Richpolis/CategoriasGaleriaBundle/Resources/views', 'CategoriasGaleria');
        ...
        $instance->addPath('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/Resources/views');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('faed65b6670198c4a275489e150e8b2445c9ea63');
    }
    ...
    /**
     * Gets the imagine service alias.
     *
     * @return Imagine\Gd\Imagine An instance of the imagine.gd service
     */
    protected function getImagineService()
    {
        return $this->get('imagine.gd');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/assetic/assets');
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CategoriasGaleriaBundle' => 'Richpolis\\CategoriasGaleriaBundle\\CategoriasGaleriaBundle',
            ...
            'locale' => 'en',
            'secret' => 'faed65b6670198c4a275489e150e8b2445c9ea63',
            'database_path' => NULL,
            'richpolis.emails.to_email' => 'richpolis@gmail.com',
            'richpolis_registros_limit' => 10,
            'richpolis_imagenes_limit' => 50,
            'richpolis_uploads' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/../web/uploads',
            ...
            'debug.container.dump' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'kernel.secret' => 'faed65b6670198c4a275489e150e8b2445c9ea63',
            ...
            'session.save_path' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/../web',
            'assetic.write_to' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/jms_diextra',
            ...
            'security.extra.cache_dir' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/cache/dev/jms_security',
            ...
            'genemu.form.file.root_dir' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/../web',
            'genemu.form.file.folder' => '/upload',
            'genemu.form.file.upload_dir' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/../web//upload',
            ...
            'imagine.web_root' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/../web',
            'imagine.source_root' => '/home/richpolis/sfproyectos/sf2LaNinaDelMezcal/app/../web',
            'imagine.cache_prefix' => 'media/cache',
            'imagine.filters' => array(
                'platillos_imagen' => array(
                    'type' => 'thumbnail',
                    'options' => array(
                        'size' => array(
                            0 => 400,
