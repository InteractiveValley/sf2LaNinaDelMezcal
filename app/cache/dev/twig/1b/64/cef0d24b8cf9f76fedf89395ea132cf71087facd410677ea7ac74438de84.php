...
/* FrontendBundle:Botellas:edit.html.twig */
class __TwigTemplate_1b64cef0d24b8cf9f76fedf89395ea132cf71087facd410677ea7ac74438de84 extends Twig_Template
{
...
";
    ...
    <form id=\"formPrincipal\" action=\"";
        // line 20
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("botellas_update", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "FrontendBundle:Botellas:edit.html.twig";
    }
