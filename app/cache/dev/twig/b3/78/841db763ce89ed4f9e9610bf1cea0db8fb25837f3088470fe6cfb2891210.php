...
/* FrontendBundle:Mensajes:edit.html.twig */
class __TwigTemplate_b378841db763ce89ed4f9e9610bf1cea0db8fb25837f3088470fe6cfb2891210 extends Twig_Template
{
...
";
    ...
    <form id=\"formPrincipal\" action=\"";
        // line 20
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("mensajes_update", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "FrontendBundle:Mensajes:edit.html.twig";
    }
