...
/* CategoriasGaleriaBundle:Galerias:edit.html.twig */
class __TwigTemplate_b2cb63e5f9763ca8220628f931ed5fbf7591a1e2044ad7d45f7515da2f5e94a1 extends Twig_Template
{
...
<form id=\"formPrincipal\" action=\"";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("galerias_update", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "CategoriasGaleriaBundle:Galerias:edit.html.twig";
    }
